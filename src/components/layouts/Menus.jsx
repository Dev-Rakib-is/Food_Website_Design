        ...
        <Container>
          <div className="">
            <Heading
              ...
              as={"h3"}
              className={
                "text-center font-medium text-[55px] text-mClr pb-[64px]"
              }
            />
          </div>
          <div>
            <Flex className={" flex-row gap-x-[24px]"}>
              <div className="pt-[40px] pb-[38px] border-2 rounded-xs px-[25px] rounded-[12px] text-center">
                <div className=" bg-hbrbg rounded-full h-[100px] m-auto w-[100px] flex items-center justify-center">
                  <svg
                    width="48"
                    height="50"
                    viewBox="0 0 48 50"
                ...
                <Heading
                  text={"Breakfast"}
                  as={"h5"}
                  className={"pt-[30px] font-bold text-[24px] text-mClr"}
                />
                <Heading
                  text={
                  ...
                  as={"p"}
                  className={"pt-[15px] pb-[31px]  text-[16px] text-pClr"}
                />
                <Button
                  btnText={"Explore Menu"}
                  className={"font-bold text-btntextClr "}
                />
              </div>
              <div className="pt-[40px] pb-[38px] border-2 rounded-xs px-[25px] rounded-[12px] text-center">
                <div className=" bg-hbrbg rounded-full h-[100px] m-auto w-[100px] flex items-center justify-center">
